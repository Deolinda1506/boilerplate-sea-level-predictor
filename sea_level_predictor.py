...
def draw_plot():
    ...
    sea_levels_predicted_recent = intercept_recent + slope_recent * years_recent
    plt.plot(years_recent, sea_levels_predicted_recent, 'g', label='Best Fit Line (2000-2050)')
